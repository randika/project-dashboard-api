...
public class MetricSonar {
    ...
    private static final String DYNAMODB_TABLE_METRICS_SONAR = System.getenv("DYNAMODB_TABLE_METRICS_SONAR");
    ...
    public MetricSonar() {
        ...
        DynamoDBMapperConfig mapperConfig = DynamoDBMapperConfig.builder()
                .withTableNameOverride(new DynamoDBMapperConfig.TableNameOverride(DYNAMODB_TABLE_METRICS_SONAR))
                .build();
        // get the db adapter
